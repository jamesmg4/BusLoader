...
public class QStudent extends EntityPathBase<Student> {
    ...
    public final ListPath<Attendee, QAttendee> attendee = this.<Attendee, QAttendee>createList("attendee", Attendee.class, QAttendee.class, PathInits.DIRECT2);

    public final QBus bus;

    public final BooleanPath busCaptain = createBoolean("busCaptain");
